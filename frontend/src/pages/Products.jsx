...
export default function Products() {
  ...
  const filteredProducts = selectedCategory
    ? allProducts.filter((_, index) =>
        index % 3 === categories.indexOf(selectedCategory) % 3
      )
    : allProducts;
      ...
      <main className="max-w-7xl mx-auto py-8 px-4">
        ...
        <div className="lg:hidden mb-4">
          <button
            ...
            className="bg-brand-green text-white px-4 py-2 rounded-xl text-sm font-bold"
          >
            Filter Categories
          </button>
        </div>
        ...
        <div className="flex gap-10">
              ...
              <ul className="space-y-1">
                <li>
                  <button
                    ...
                    className={`w-full py-2 px-4 rounded-xl text-sm font-bold ${
                      !selectedCategory
          ...
          <div className="flex-1">
            ...
            {/* TOOLBAR */}
            <div className="flex flex-col sm:flex-row justify-between gap-4 mb-8 bg-gray-50 p-4 rounded-2xl border">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="border rounded-lg px-3 py-1 text-xs font-bold"
                  >
              ...
              <ul className="space-y-2">
                <li>
                  <button
                    ...
                    className="w-full py-2 px-4 bg-brand-green text-white rounded-xl font-bold"
                  >
                    All Products
                  </button>
                </li>
                ...
                {categories.map((cat) => (
                  <li key={cat}>
                    <button
                      ...
                      className="w-full py-2 px-4 rounded-xl font-bold text-gray-600 hover:bg-gray-100"
                    >
                      {cat}
                    </button>
                  </li>
